        ...
        try:
            ...
            with st.spinner("جاري التفكير..."):
                response = client.responses.create(
                    model="gpt-4o-mini",
                    input=[
                        {"role": "system", "content": "  انت مساعدي واسمك نبراس اجب بردود وافيه ومتوسطه ودايم ابحث بالويب اذا سالك المستخدم وكن صديق حنون ودود وردودك جميله ورحب بالمستخدم وتكلم معه بلهجه سعوديه عاميه."},
                        *st.session_state.messages
                    ],
